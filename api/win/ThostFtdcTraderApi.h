...
public:
	...
	///获取真实国密厂商协议类型
	///用于客户端连接smagent代理时
	///@retrun 1:格尔; 2:信安; 3:信雅达; 0:其他非国密协议
	virtual THOST_SM_PROTOCOL_TYPE GetSMProtocol() = 0;
	...
	///
	virtual int ReqUserLoginSM(CThostFtdcReqUserLoginSMField *pReqUserLoginSM, int nRequestID) = 0;
